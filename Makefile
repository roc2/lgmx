...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu Mar 28 16:49:23 2013
# Project:  lgmx.pro
# Template: app
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Isrc/utils -Isrc/core -Isrc/core/highlight -Isrc/core/tags -I/usr/local/include -Isrc/core/vjson -Isrc/core/cli -I.
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -L./plugins -llgmx_cpp_highlighter -lfl -L/usr/local/lib -lsource-highlight-qt4 -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = src/core/main.cpp \
		...
		src/core/tags/readtags.cpp moc_code_editor.cpp \
		moc_main_window.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/editor1.0.0/ && $(COPY_FILE) --parents debug.h src/core/code_editor.h src/core/main_window.h src/core/src_container.h src/core/highlight/cpp/cpp_hl.h go_to_line.h ui_go_to_line.h src/core/src_file.h config.h unsvFileDialog.h src/core/file_watcher.h src/core/recent_files.h search.h src/core/clipboard.h src/core/view_manager.h src/core/view.h src/core/status_line.h utils.h src/utils/id.h src/core/exception.h src/core/interfaces.h src/core/file_type.h src/core/plugin_manager.h src/core/highlight/highlight_manager.h src/core/vjson/block_allocator.h src/core/vjson/json.h src/core/settings.h src/core/c_label.h src/core/text_manip.h src/core/cli/cli.h command.h src/core/highlight/syntax_highlighter.h src/core/tags/tags.h src/core/tags/readtags.h .tmp/editor1.0.0/ && $(COPY_FILE) --parents src/core/main.cpp src/core/main_window.cpp src/core/code_editor.cpp src/core/src_container.cpp src/core/highlight/cpp/cpp_hl.cpp go_to_line.cpp src/core/src_file.cpp config.cpp unsvFileDialog.cpp src/core/file_watcher.cpp src/core/recent_files.cpp search.cpp src/core/clipboard.cpp src/core/view_manager.cpp src/core/view.cpp src/core/status_line.cpp src/utils/id.cpp src/core/file_type.cpp src/core/plugin_manager.cpp src/core/highlight/highlight_manager.cpp src/core/vjson/block_allocator.cpp src/core/vjson/json.cpp src/core/settings.cpp src/core/c_label.cpp src/core/text_manip.cpp src/core/cli/cli.cpp command.cpp src/core/highlight/syntax_highlighter.cpp src/core/tags/tags.cpp src/core/tags/readtags.cpp .tmp/editor1.0.0/ && (cd `dirname .tmp/editor1.0.0` && $(TAR) editor1.0.0.tar editor1.0.0 && $(COMPRESS) editor1.0.0.tar) && $(MOVE) `dirname .tmp/editor1.0.0`/editor1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/editor1.0.0
...
compiler_moc_header_make_all: moc_code_editor.cpp moc_main_window.cpp moc_src_container.cpp moc_cpp_hl.cpp moc_go_to_line.cpp moc_src_file.cpp moc_unsvFileDialog.cpp moc_file_watcher.cpp moc_recent_files.cpp moc_search.cpp moc_clipboard.cpp moc_view_manager.cpp moc_view.cpp moc_status_line.cpp moc_c_label.cpp moc_text_manip.cpp moc_cli.cpp moc_syntax_highlighter.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_code_editor.cpp moc_main_window.cpp moc_src_container.cpp moc_cpp_hl.cpp moc_go_to_line.cpp moc_src_file.cpp moc_unsvFileDialog.cpp moc_file_watcher.cpp moc_recent_files.cpp moc_search.cpp moc_clipboard.cpp moc_view_manager.cpp moc_view.cpp moc_status_line.cpp moc_c_label.cpp moc_text_manip.cpp moc_cli.cpp moc_syntax_highlighter.cpp
moc_code_editor.cpp: src/core/code_editor.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/core/code_editor.h -o moc_code_editor.cpp

moc_main_window.cpp: go_to_line.h \
		ui_go_to_line.h \
		search.h \
...
main_window.o: src/core/main_window.cpp config.h \
		debug.h
...
file_watcher.o: src/core/file_watcher.cpp debug.h
...
view_manager.o: src/core/view_manager.cpp debug.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o view_manager.o src/core/view_manager.cpp

view.o: src/core/view.cpp debug.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o view.o src/core/view.cpp

status_line.o: src/core/status_line.cpp debug.h
...
highlight_manager.o: src/core/highlight/highlight_manager.cpp debug.h
...
cli.o: src/core/cli/cli.cpp debug.h
