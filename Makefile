...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sat Nov 3 19:51:30 2012
# Project:  lgmx.pro
# Template: app
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtXml -I/usr/include/qt4 -Isrc/utils -Isrc/core -Isrc/core/highlight -I/usr/local/include -I.
LINK          = g++
LFLAGS        = 
...
SOURCES       = src/core/main.cpp \
		...
		src/core/highlight/highlight_manager.cpp moc_code_editor.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/editor1.0.0/ && $(COPY_FILE) --parents debug.h src/core/code_editor.h ui_main_window.h src/core/src_container.h src/core/highlight/cpp/cpp_hl.h go_to_line.h ui_go_to_line.h src/core/src_file.h config.h unsvFileDialog.h file_watcher.h recent_files.h search.h clipboard.h view_manager.h src/core/view.h status_line.h utils.h src/utils/id.h src/core/exception.h src/core/interfaces.h src/core/file_type.h src/core/plugin_manager.h src/core/highlight/highlight_manager.h src/core/highlight/highlighter.h .tmp/editor1.0.0/ && $(COPY_FILE) --parents src/core/main.cpp ui_main_window.cpp src/core/code_editor.cpp src/core/src_container.cpp src/core/highlight/cpp/cpp_hl.cpp go_to_line.cpp src/core/src_file.cpp config.cpp unsvFileDialog.cpp file_watcher.cpp recent_files.cpp search.cpp clipboard.cpp view_manager.cpp src/core/view.cpp status_line.cpp src/utils/id.cpp src/core/file_type.cpp src/core/plugin_manager.cpp src/core/highlight/cpp/lex.yy.cpp src/core/highlight/highlight_manager.cpp .tmp/editor1.0.0/ && (cd `dirname .tmp/editor1.0.0` && $(TAR) editor1.0.0.tar editor1.0.0 && $(COMPRESS) editor1.0.0.tar) && $(MOVE) `dirname .tmp/editor1.0.0`/editor1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/editor1.0.0
...
compiler_moc_header_clean:
	-$(DEL_FILE) moc_code_editor.cpp moc_ui_main_window.cpp moc_src_container.cpp moc_cpp_hl.cpp moc_go_to_line.cpp moc_src_file.cpp moc_unsvFileDialog.cpp moc_file_watcher.cpp moc_recent_files.cpp moc_search.cpp moc_clipboard.cpp moc_view_manager.cpp moc_view.cpp moc_status_line.cpp moc_highlighter.cpp
