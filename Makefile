...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue May 15 20:34:27 2012
# Project:  lgmx.pro
# Template: app
...
compiler_moc_header_make_all: moc_code_editor.cpp moc_ui_main_window.cpp moc_src_container.cpp moc_cpp_hl.cpp moc_go_to_line.cpp moc_src_file.cpp moc_unsvFileDialog.cpp moc_file_watcher.cpp moc_recent_files.cpp moc_search.cpp moc_clipboard.cpp moc_view_manager.cpp moc_view.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_code_editor.cpp moc_ui_main_window.cpp moc_src_container.cpp moc_cpp_hl.cpp moc_go_to_line.cpp moc_src_file.cpp moc_unsvFileDialog.cpp moc_file_watcher.cpp moc_recent_files.cpp moc_search.cpp moc_clipboard.cpp moc_view_manager.cpp moc_view.cpp
