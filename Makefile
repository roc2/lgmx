...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Thu Mar 22 23:48:26 2012
# Project:  lgmx.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		recent_files.cpp \
		search.cpp \
		clipboard.cpp moc_code_editor.cpp \
...
Makefile: lgmx.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
		/usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/qconfig.pri \
		/usr/share/qt4/mkspecs/modules/qt_webkit_version.pri \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/editor1.0.0/ && $(COPY_FILE) --parents code_editor.h ui_main_window.h src_area.h highlight/cpp_hl.h go_to_line.h ui_go_to_line.h src_file.h config.h unsvFileDialog.h file_watcher.h recent_files.h search.h clipboard.h .tmp/editor1.0.0/ && $(COPY_FILE) --parents main.cpp ui_main_window.cpp code_editor.cpp src_area.cpp highlight/cpp_hl.cpp go_to_line.cpp src_file.cpp config.cpp unsvFileDialog.cpp file_watcher.cpp recent_files.cpp search.cpp clipboard.cpp .tmp/editor1.0.0/ && (cd `dirname .tmp/editor1.0.0` && $(TAR) editor1.0.0.tar editor1.0.0 && $(COMPRESS) editor1.0.0.tar) && $(MOVE) `dirname .tmp/editor1.0.0`/editor1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/editor1.0.0
...
compiler_moc_header_make_all: moc_code_editor.cpp moc_ui_main_window.cpp moc_src_area.cpp moc_cpp_hl.cpp moc_go_to_line.cpp moc_unsvFileDialog.cpp moc_file_watcher.cpp moc_recent_files.cpp moc_search.cpp moc_clipboard.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_code_editor.cpp moc_ui_main_window.cpp moc_src_area.cpp moc_cpp_hl.cpp moc_go_to_line.cpp moc_unsvFileDialog.cpp moc_file_watcher.cpp moc_recent_files.cpp moc_search.cpp moc_clipboard.cpp
...
moc_src_area.cpp: code_editor.h \
		highlight/cpp_hl.h \
		src_file.h \
		src_area.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src_area.h -o moc_src_area.cpp
...
moc_src_area.o: moc_src_area.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_src_area.o moc_src_area.cpp
