...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Jan 9 02:40:01 2013
# Project:  lgmx.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/editor1.0.0/ && $(COPY_FILE) --parents debug.h src/core/code_editor.h ui_main_window.h src/core/src_container.h src/core/highlight/cpp/cpp_hl.h go_to_line.h ui_go_to_line.h src/core/src_file.h config.h unsvFileDialog.h file_watcher.h recent_files.h search.h src/core/clipboard.h view_manager.h src/core/view.h status_line.h utils.h src/utils/id.h src/core/exception.h src/core/interfaces.h src/core/file_type.h src/core/plugin_manager.h src/core/highlight/highlight_manager.h src/core/highlight/highlighter.h src/core/vjson/block_allocator.h src/core/vjson/json.h src/core/settings.h src/core/c_label.h src/core/text_manip.h cli.h cli_iface.h command.h .tmp/editor1.0.0/ && $(COPY_FILE) --parents src/core/main.cpp ui_main_window.cpp src/core/code_editor.cpp src/core/src_container.cpp src/core/highlight/cpp/cpp_hl.cpp go_to_line.cpp src/core/src_file.cpp config.cpp unsvFileDialog.cpp file_watcher.cpp recent_files.cpp search.cpp src/core/clipboard.cpp view_manager.cpp src/core/view.cpp status_line.cpp src/utils/id.cpp src/core/file_type.cpp src/core/plugin_manager.cpp src/core/highlight/cpp/lex.yy.cpp src/core/highlight/highlight_manager.cpp src/core/vjson/block_allocator.cpp src/core/vjson/json.cpp src/core/settings.cpp src/core/c_label.cpp src/core/text_manip.cpp cli.cpp cli_iface.cpp command.cpp .tmp/editor1.0.0/ && (cd `dirname .tmp/editor1.0.0` && $(TAR) editor1.0.0.tar editor1.0.0 && $(COMPRESS) editor1.0.0.tar) && $(MOVE) `dirname .tmp/editor1.0.0`/editor1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/editor1.0.0
...
moc_cli_iface.cpp: cli.h \
		cli_iface.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) cli_iface.h -o moc_cli_iface.cpp
...
cli_iface.o: cli_iface.cpp cli_iface.h \
		cli.h \
		debug.h \
		view_manager.h \
		recent_files.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o cli_iface.o cli_iface.cpp
...
moc_cli_iface.o: moc_cli_iface.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_cli_iface.o moc_cli_iface.cpp
